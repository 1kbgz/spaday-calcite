...
<style>
  * { box-sizing: border-box; }
  ...
  .component-preview { display: grid; align-content: center; min-width: 0; min-height: 6rem; max-height: 18rem; overflow: auto; padding: .75rem; border: 1px dashed var(--calcite-color-border-2); }
